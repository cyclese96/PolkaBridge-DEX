...
export function handleSync(event: Sync): void {
  ...
  PolkabridgeAmm.totalLiquidityETH = PolkabridgeAmm.totalLiquidityETH.minus(
  ...
  PolkabridgeAmm.totalLiquidityETH = PolkabridgeAmm.totalLiquidityETH.plus(
    trackedLiquidityETH
  );
  PolkabridgeAmm.totalLiquidityUSD = PolkabridgeAmm.totalLiquidityETH.times(
    bundle.ethPrice
  );
...
export function handleSwap(event: Swap): void {
  ...
  let PolkabridgeAmm = PolkabridgeAmmFactory.load(FACTORY_ADDRESS);
  PolkabridgeAmm.totalVolumeUSD = PolkabridgeAmm.totalVolumeUSD.plus(
    trackedAmountUSD
  );
  PolkabridgeAmm.totalVolumeETH = PolkabridgeAmm.totalVolumeETH.plus(
    trackedAmountETH
  );
  PolkabridgeAmm.untrackedVolumeUSD = PolkabridgeAmm.untrackedVolumeUSD.plus(
    derivedAmountUSD
  );
  PolkabridgeAmm.txCount = PolkabridgeAmm.txCount.plus(ONE_BI);
  ...
  PolkabridgeAmmDayData.dailyVolumeUSD = PolkabridgeAmmDayData.dailyVolumeUSD.plus(
    trackedAmountUSD
  );
  PolkabridgeAmmDayData.dailyVolumeETH = PolkabridgeAmmDayData.dailyVolumeETH.plus(
    trackedAmountETH
  );
  PolkabridgeAmmDayData.dailyVolumeUntracked = PolkabridgeAmmDayData.dailyVolumeUntracked.plus(
    derivedAmountUSD
  );
