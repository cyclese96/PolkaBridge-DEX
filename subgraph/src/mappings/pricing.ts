...
import { ZERO_BD, factoryContract, ADDRESS_ZERO, ONE_BD, UNTRACKED_PAIRS, testing } from './helpers'
...
export function getEthPriceInUSD(): BigDecimal {
  ...
  //   return ZERO_BD
  // }
  // if (usdtPairTest !== null) {
  //   return usdtPairTest.token0Price;
  // } else {
  //   return ZERO_BD;
  // }
}
...
let WHITELIST: string[] = testing ? [
  "0xc778417e063141139fce010982780140aa0cd5ab", //WETH_ADDRESS_TESTNET
  "0xe687b0a94c3a20540552d981cd311a6812759df8", // usdt testnet
